...
- [MetaReview](https://metareview-8c1.pages.dev/) - Free, open-source meta-analysis platform for systematic reviews. Includes PubMed search, AI literature screening, statistical engine (OR/RR/HR/MD/SMD), 11 interactive charts, PRISMA 2020 flowchart, and automated results/methods paragraph generation for reproducible evidence synthesis. ([GitHub](https://github.com/TerryFYL/metareview))
